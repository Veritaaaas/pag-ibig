                    ...
                    <tbody className="text-[18px] text-[#636363] font-semibold">
                        {members.map((member) => (
                            <tr key={member.pi_mid} className="border-b-2 border-gray-200" onClick={() => handleRowClick(member)}>
                                ...
                                <td className="px-10 py-2">{member.Name}</td>
                                <td className="px-10 py-2">{member.FatherName}</td>
                                <td className="px-10 py-2">{member.MotherName}</td>
                                <td className="px-10 py-2">{member.SpouseName}</td>
                                <td className="px-10 py-2">{member.BirthDate}</td>
                                <td className="px-10 py-2">{member.BirthPlace}</td>
                                ...
                                <td className="px-10 py-2">{member.BusinessTrunkLine}</td>
                                <td className="px-10 py-2">{member.EmailAddress}</td>
                                <td className="px-10 py-2">{member.CompanyCode}</td>
                            </tr>
                        ))}
                    </tbody>
            </table>
